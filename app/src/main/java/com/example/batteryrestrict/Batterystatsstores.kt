...
data class BatteryStatsSnapshot(
    ...
    val monitorScreenOnMs: Long,       // screen-on time since the monitor service was started
    val monitorScreenOffMs: Long       // screen-off time since the monitor service was started
)
